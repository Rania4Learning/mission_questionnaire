...
def generate_json_file(categorie, titre, url):
    ...
    try:
        ...
        print("Exception pour la requete HTTP GET sur l'url: ", url )
    finally:
        try:
            ...
            print(f"Exception dans la désérialisation ou utilistaion des données (questionnaire : {titre},url : {url} )")
